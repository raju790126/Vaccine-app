...
<body>
	...
	<div class="container">
	<header> <li><a href="backToHome">Back</a></li></header>
  <h1>HTML registration form with varification</h1>
  <div><form name="registration" class="registartion-form" onsubmit="return formValidation()">
    <table>
      <tr>
      ...
      <tr>
        ...
        <td>
          <select name="idproof" id="idproof">
            ...
            <option value="English">AadharCard</option>
            <option value="Spanish">PanCard</option>
            <option value="Hindi">PassPort</option>
          </select>
        </td>
      </tr>
      <tr>
        <td><label for="proofno">Proof-ID-No:</label></td>
        <td><input type="text" name="proofno" id="proofno"></td>
      </tr>
      <tr>
        <td><label for="idproof">Vaccine-Type:</label></td>
        <td>
          <select name="idproof" id="idproof">
            <option value="">Select language</option>
